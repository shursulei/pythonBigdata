...
def gen_history_prescription_by_month(yearmonth_datetime, prescription_doctor_num,
    ...
    # 当月处方订单先直接生成处方
    #获取当月处方订单已经生成的医院患者的id
    #获取当月处方订单已经生成非医院患者的id
    #获取当月订单的所有存放的量
...
def get_patient_doctor_pool(yearmonth_datetime, order_hospital_patient_id_set, order_common_patient_id_set, prescription_num, patient_hospital_num, patient_common_num):
...
def get_gmt_create_before_order_time(order_time):
    ...
    if start == end:
        return order_time
    return order_time - datetime.timedelta(minutes=random.randint(start, end))
