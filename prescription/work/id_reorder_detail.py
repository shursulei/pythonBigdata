...
PRES_DETAIL_INSERT_SQL = '''insert into prescription_detail_id_reorder(`old_id`, gmt_create, new_id) values '''
...
def write_pres_detail_sql(pres_detail_list: typing.List, arg_dict):
    ...
    filename = Path(data_dir, "prescription_detail333_id_{arg_dict['ym_date'].year}_{arg_dict['ym_date'].month}.sql")
